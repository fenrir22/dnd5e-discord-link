...
export class BotClient {
  ...
  _buildActions(actor) {
    ...
    const canAttack = (item) =>
      item.system?.activities?.some(a => a.type === 'attack' || a.type === 'save') || !!(item.system?.actionType && item.system.actionType !== 'utility');
    return {
